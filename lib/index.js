...
function apply(ctx, config) {
    let server = null, bot = null, messageQueue = [], sessionFlag = false, triggerSuccess = false, max = false, max_ = false, hasExecuted = false, errorCount = 0, isClosingScheduled = false;
