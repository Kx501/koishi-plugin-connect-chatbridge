...
exports.Config = koishi_1.Schema.intersect([
    ...
    koishi_1.Schema.object({
        使用被动方式转发: koishi_1.Schema.boolean().default(false).description('当频道内有人发言时才发送消息，配合触发时长使用。超时采用主动发送。').experimental(),
        等待触发时长: koishi_1.Schema.number().default(2000).description('(毫秒)，启用后转发到 QQ 的消息会有延迟。效果自行测试。').experimental(),
